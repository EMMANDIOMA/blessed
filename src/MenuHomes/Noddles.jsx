          ...
          <div className="sm:w-[50%] px-2 ">
            <div className="mt-3">
              ...
              <p className="mt-8 text-2xl font-semibold font-serif text-[#E46419]">
                A burst of Asian-inspired flavors.{" "}
              </p>
              <p className="text-justify mt-7 text-xl text-[#51453F]">
                Quick, fresh, and full of flavor. Our Stir-Fry Noodles are
                tossed in a high-heat wok with seasonal vegetables, ginger,
                garlic, and our proprietary umami-rich sauce that provides the
              ...
              <div className="flex  justify-between">
                <div className="flex text-xl flex-col gap-1.5 text-[grey]">
                  <p>price</p>
                  <p className="text-[#E46212] text-xl font-semibold">2,500</p>
                </div>
                <div className="mt-7">
